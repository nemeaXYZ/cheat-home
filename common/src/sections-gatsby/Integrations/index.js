            ...
            <div className="integration__block__wrap">
              <div className="integration__block">
                <div className="integration__block__inner">
                  <img src={integrationImage1} alt="Cheat integration" />
                  <h3>Mail Chimp</h3>
                  <p>Send Emails</p>
                  <Link to="#">
                    <img src={Icon} alt="Cheat app" />
                  </Link>
                </div>
                <div className="integration__block__inner">
                  <img src={integrationImage2} alt="Cheat integration" />
                  <h3>Instagram</h3>
                  <p>News Feed</p>
                  <Link to="#">
                    <img src={Icon} alt="Cheat app" />
              ...
              <div className="integration__block right">
                <div className="integration__block__inner">
                  <img src={integrationImage3} alt="Cheat integration" />
                  <h3>Slack</h3>
                  <p>Messaging</p>
                  <Link to="#">
                    <img src={Icon} alt="Cheat app" />
                ...
                <div className="integration__block__inner">
                  <img src={integrationImage4} alt="Cheat integration" />
                  <h3>twitter</h3>
                  <p>News Feed</p>
                  <Link to="#">
                    <img src={Icon} alt="Cheat app" />
