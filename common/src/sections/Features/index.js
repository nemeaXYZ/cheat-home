        ...
        <Row>
          <Col xs={12} sm={6} md={4}>
            <div className="fetures-block v1">
              ...
              <p>
                Don't get blindsided by the complication of incorporation. We
                will lead you through the pitfalls that will suck your time and
                energy. Because we've seen it before.
              </p>
            </div>
          </Col>
          <Col xs={12} sm={6} md={4}>
            <div className="fetures-block v2">
              ...
              <p>
                Will your business be able to profit? Do you have the funding
                you need to start? Our automated calculations will give you
                guide rails while developing your product, engaging your market,
                and building your userbase.
              </p>
            </div>
          </Col>
          <Col xs={12} sm={6} md={4}>
            <div className="fetures-block v1">
              ...
              <h3>Intellegent Suggestion</h3>
              <p>
                How much money do you really need to start? Do you really need
                to buy that equipment today? How much inventory should you keep
                on hand? We help you maximize the efficiency of your business by
                not making rookie mistakes.
              </p>
            </div>
          </Col>
          {/*
