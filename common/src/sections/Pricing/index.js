    ...
    <PricingSectionWrapper id="pricing">
      ...
      <Container>
        <SectionTitle UniWidth="65%">
          <h4>Pricing Table</h4>
          <h2>
            Nearly <span>90% of startups fail</span> and lose their investment.
          </h2>
          <h2>
            We help you to <span>succeed </span> at a massive discount.
          </h2>
        </SectionTitle>
        <Row>
            ...
            <Col xs={12} sm={6} lg={4} key={index}>
              <div className="pricing-block">
                <div className="thumb-block">
                  <img src={pricing.thumb} alt="Cheat app landing" />
                </div>
